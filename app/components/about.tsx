            ...
            <div className="col-md-10">
              <div className="card">
                ...
                >
                  ...
                  <p>I have experience with microservices and event-driven architecture. Work in E-commerce on apps and website backend, discounts, catalog, pricing, checkout, cart and other systems.</p>
